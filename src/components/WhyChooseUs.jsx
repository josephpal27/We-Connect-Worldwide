    ...
    return (
        <>
            <section className="
                ...
                py-[0.5rem] sm:py-[2rem] lg:py-[1rem] xl:py-[1.5rem] 2xl:py-[2rem]
                ...
                ">
                    ...
                    ">
                        <img src={brickImg} alt="Brick Image" loading="lazy" className="
                            ...
                            rounded-[30px] sm:rounded-[40px] lg:rounded-[40px] xl:rounded-[45px] 2xl:rounded-[50px]
                        " />
                    </div>
                    <div className="
                        d-flex
                        w-[70%] sm:w-[50%]
                        items-end
                        mt-[9rem] sm:mt-[12rem] lg:mt-[10rem] xl:mt-[11rem] 2xl:mt-[12rem]
                        mr-[1rem] sm:mr-[1.2rem] lg:mr-[1.4rem] xl:mr-[1.5rem] 2xl:mr-[1.7rem]
                    ">
